...
resource	'用户 打分表 查看修改（全角色通用）' do
  ...
  put '/evaluations/:id' do
    middle_manager_attrs = FactoryGirl.attributes_for(:middle_manager)

    header "X-User-Token", middle_manager_attrs[:authentication_token]
    header "X-User-JobNum", middle_manager_attrs[:job_num]
    
    parameter :thought_morals, "思想道德情况. 项目与分数 英文逗号隔开，项目之间 英文分号隔开， 例：'项目1,80;项目2,70;项目3,60;项目4,90'", required: false, scope: :evaluation
    ...
    parameter :evaluation_totality, "总体评价", required: false, scope: :evaluation
