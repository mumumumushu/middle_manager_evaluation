class EvaluationsController < ApplicationController
  ...
  def index
    ...
    respond_with @evaluations, template: "middle_managers/evaluations/index", status: 200
  end

  def show
    respond_with @evaluation, template: "middle_managers/evaluations/show", status: 200
  end
